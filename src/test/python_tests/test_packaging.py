...
def test_flake8_metadata_version():
    """importlib.metadata must resolve the bundled flake8 version."""
    version = importlib.metadata.version("flake8")
    assert version, "flake8 version string should not be empty"
    parts = version.split(".")
